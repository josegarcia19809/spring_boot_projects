...
public class PersonalInfoRepositoryImpl implements IPersonalInfoRepository {
    ...
    public PersonalInfo save(PersonalInfo personalInfo) {
        if (personalInfo.getId() == null) {
            String sql = "INSERT INTO personal_info (first_name, last_name, title, " +
                    "profile_description, profile_image_url, years_of_experience, " +
            ...
            jdbcTemplate.update(connection -> {
                ...
                // Para tipos primitivos que pueden ser nulos en la DB (INT),
                // usa setNull si el valor es null
            ...
            String sql = "UPDATE personal_info SET first_name=?, last_name=?, " +
                    "title=?, profile_description=?, " +
